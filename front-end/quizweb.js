const quizData = [
    ...
    {
      question: 'A loop that never ends is reffered to as a(n)?',
      options: ['While loop', 'Recursive loop', 'Infinite loop', 'for loop'],
    ...
    {
      question: 'A program written originally by the programmer is classified as..?',
      options: [
        'object code',
        'Machine code',
        'Source code',
